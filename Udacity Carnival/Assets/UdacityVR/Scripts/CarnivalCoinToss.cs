...
public class CarnivalCoinToss : MonoBehaviour {
    ...
    public GameObject coinTossPlatform;
	...
	void Start() {
        ...
        coinTossPlatform = GameObject.Find("Coin_Toss_Stand_Platform");
        platformPosition = coinTossPlatform.transform;
	}
